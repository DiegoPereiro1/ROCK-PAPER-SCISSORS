...
Victories = {
    ...
    GameAction.Rock: [GameAction.Paper,GameAction.Lizard],
    
    GameAction.Paper: [GameAction.Scissors,GameAction.Spock],
    
    GameAction.Scissors: [GameAction.Rock,GameAction.Lizard],
